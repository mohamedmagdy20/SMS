...
<section class="content-header">
    <h1>
        الادوار والصلاحيات
      <small>عرض الادوار والصلاحيات</small>
    </h1>
    <ol class="breadcrumb">
      <li><a href="{{route('dashboard')}}"><i class="fa fa-dashboard"></i> لوحه التحكم</a></li>
      <li class="active">الادوار والصلاحيات</li>
    </ol>
  </section>
      ...
      <div class="col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">الادوار والصلاحيات</h3>
          </div><!-- /.box-header -->

          <div class="text-center">
            <a href="{{route('dashboard.roles.create')}}" class="btn btn-primary">اضافه +</a>
        </div>
          <div class="box-body">
