      ...
      <div class="col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">الفصول الدراسيه</h3>
          </div><!-- /.box-header -->

          <div class="text-center">
            <a href="{{route('dashboard.semester.create')}}" class="btn btn-primary">اضافه +</a>
        </div>
          <div class="box-body">
...
function setSubjectDatatable() {
    var url = "{{ route('dashboard.semester.data') }}";
...
function deleteConfirmation(id) {
        swal({
            ...
            if (e.value === true) {
                ...
                $.ajax({
                    type: 'GET',
                    url: "{{url('dashboard/semester/delete')}}/" + id,
